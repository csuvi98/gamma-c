...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.interface_.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_parents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_parents_feature", "_UI_Interface_type"),
				 InterfaceModelPackage.Literals.INTERFACE__PARENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InterfaceModelPackage.Literals.INTERFACE__EVENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Interface.class)) {
			case InterfaceModelPackage.INTERFACE__EVENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InterfaceModelPackage.Literals.INTERFACE__EVENTS,
				 InterfaceModelFactory.eINSTANCE.createEventDeclaration()));
	}
