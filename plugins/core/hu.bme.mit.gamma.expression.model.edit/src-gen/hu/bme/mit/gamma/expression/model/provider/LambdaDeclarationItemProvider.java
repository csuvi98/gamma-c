...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.expression.model.LambdaDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LambdaDeclarationItemProvider extends InitializableElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LambdaDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionModelPackage.Literals.DECLARATION__TYPE);
	...
	/**
	 * This returns LambdaDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LambdaDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((LambdaDeclaration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LambdaDeclaration_type") :
			getString("_UI_LambdaDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LambdaDeclaration.class)) {
			case ExpressionModelPackage.LAMBDA_DECLARATION__TYPE:
			case ExpressionModelPackage.LAMBDA_DECLARATION__PARAMETER_DECLARATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionModelPackage.Literals.DECLARATION__TYPE,
