...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.expression.model.InitializableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InitializableElementItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public InitializableElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionModelPackage.Literals.INITIALIZABLE_ELEMENT__EXPRESSION);
		}
	...
	public String getText(Object object) {
		String label = ((InitializableElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InitializableElement_type") :
			getString("_UI_InitializableElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InitializableElement.class)) {
			case ExpressionModelPackage.INITIALIZABLE_ELEMENT__EXPRESSION:
