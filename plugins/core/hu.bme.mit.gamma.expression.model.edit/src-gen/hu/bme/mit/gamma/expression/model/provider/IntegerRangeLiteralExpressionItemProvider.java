...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.expression.model.IntegerRangeLiteralExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerRangeLiteralExpressionItemProvider extends LiteralExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IntegerRangeLiteralExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLeftInclusivePropertyDescriptor(object);
			addRightInclusivePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Left Inclusive feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLeftInclusivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerRangeLiteralExpression_leftInclusive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerRangeLiteralExpression_leftInclusive_feature", "_UI_IntegerRangeLiteralExpression_type"),
				 ExpressionModelPackage.Literals.INTEGER_RANGE_LITERAL_EXPRESSION__LEFT_INCLUSIVE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Right Inclusive feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRightInclusivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerRangeLiteralExpression_rightInclusive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerRangeLiteralExpression_rightInclusive_feature", "_UI_IntegerRangeLiteralExpression_type"),
				 ExpressionModelPackage.Literals.INTEGER_RANGE_LITERAL_EXPRESSION__RIGHT_INCLUSIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This returns IntegerRangeLiteralExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IntegerRangeLiteralExpression"));
	}
	...
	public String getText(Object object) {
		IntegerRangeLiteralExpression integerRangeLiteralExpression = (IntegerRangeLiteralExpression)object;
		return getString("_UI_IntegerRangeLiteralExpression_type") + " " + integerRangeLiteralExpression.isLeftInclusive();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerRangeLiteralExpression.class)) {
			case ExpressionModelPackage.INTEGER_RANGE_LITERAL_EXPRESSION__LEFT_INCLUSIVE:
			case ExpressionModelPackage.INTEGER_RANGE_LITERAL_EXPRESSION__RIGHT_INCLUSIVE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ExpressionModelPackage.INTEGER_RANGE_LITERAL_EXPRESSION__LEFT_OPERAND:
			case ExpressionModelPackage.INTEGER_RANGE_LITERAL_EXPRESSION__RIGHT_OPERAND:
