...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.InterfaceRealization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceRealizationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatechartModelPackage.Literals.INTERFACE_REALIZATION__REALIZATION_MODE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatechartModelPackage.Literals.INTERFACE_REALIZATION__INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InterfaceRealization.class)) {
			case StatechartModelPackage.INTERFACE_REALIZATION__REALIZATION_MODE:
