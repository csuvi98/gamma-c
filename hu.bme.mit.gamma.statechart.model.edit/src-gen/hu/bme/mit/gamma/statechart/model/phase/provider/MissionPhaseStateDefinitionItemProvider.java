...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.phase.MissionPhaseStateDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionPhaseStateDefinitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__HISTORY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__COMPONENT);
			childrenFeatures.add(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__PORT_BINDINGS);
			childrenFeatures.add(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__VARIABLE_BINDINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MissionPhaseStateDefinition.class)) {
			case PhasePackage.MISSION_PHASE_STATE_DEFINITION__HISTORY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PhasePackage.MISSION_PHASE_STATE_DEFINITION__COMPONENT:
			case PhasePackage.MISSION_PHASE_STATE_DEFINITION__PORT_BINDINGS:
			case PhasePackage.MISSION_PHASE_STATE_DEFINITION__VARIABLE_BINDINGS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__COMPONENT,
				 CompositeFactory.eINSTANCE.createSynchronousComponentInstance()));

		newChildDescriptors.add
			(createChildParameter
				(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__PORT_BINDINGS,
				 CompositeFactory.eINSTANCE.createPortBinding()));

		newChildDescriptors.add
			(createChildParameter
				(PhasePackage.Literals.MISSION_PHASE_STATE_DEFINITION__VARIABLE_BINDINGS,
				 PhaseFactory.eINSTANCE.createVariableBinding()));
	}
