...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.composite.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositePackage.Literals.COMPONENT__PORTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Component.class)) {
			case CompositePackage.COMPONENT__PARAMETER_DECLARATIONS:
			case CompositePackage.COMPONENT__PORTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CompositePackage.Literals.COMPONENT__PORTS,
				 StatechartModelFactory.eINSTANCE.createPort()));
	}
