...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.composite.ControlSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlSpecificationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CompositePackage.Literals.CONTROL_SPECIFICATION__CONTROL_FUNCTION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositePackage.Literals.CONTROL_SPECIFICATION__TRIGGER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ControlSpecification.class)) {
			case CompositePackage.CONTROL_SPECIFICATION__CONTROL_FUNCTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case CompositePackage.CONTROL_SPECIFICATION__TRIGGER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CompositePackage.Literals.CONTROL_SPECIFICATION__TRIGGER,
