...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		newChildDescriptors.add
			(createChildParameter
				(StatechartModelPackage.Literals.STATE__ANNOTATION,
				 ContractFactory.eINSTANCE.createStateContractAnnotation()));

		newChildDescriptors.add
			(createChildParameter
				(StatechartModelPackage.Literals.STATE__ANNOTATION,
				 PhaseFactory.eINSTANCE.createMissionPhaseStateAnnotation()));
	}
