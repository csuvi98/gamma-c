...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.interface_.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InterfacePackage.Literals.INTERFACE__PARENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InterfacePackage.Literals.INTERFACE__EVENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Interface.class)) {
			case InterfacePackage.INTERFACE__EVENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InterfacePackage.Literals.INTERFACE__EVENTS,
				 InterfaceFactory.eINSTANCE.createEventDeclaration()));
	}
