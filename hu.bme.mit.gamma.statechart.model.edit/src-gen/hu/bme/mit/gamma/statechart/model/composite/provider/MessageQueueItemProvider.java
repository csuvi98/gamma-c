...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.composite.MessageQueue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageQueueItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEventReferencePropertyDescriptor(object);
		}
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageQueue_capacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageQueue_capacity_feature", "_UI_MessageQueue_type"),
				 CompositePackage.Literals.MESSAGE_QUEUE__CAPACITY,
				 true,
				 false,
				 false,
				 null,
	...
	/**
	 * This adds a property descriptor for the Event Reference feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEventReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageQueue_eventReference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageQueue_eventReference_feature", "_UI_MessageQueue_type"),
				 CompositePackage.Literals.MESSAGE_QUEUE__EVENT_REFERENCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositePackage.Literals.MESSAGE_QUEUE__EVENT_REFERENCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MessageQueue.class)) {
			case CompositePackage.MESSAGE_QUEUE__PRIORITY:
			case CompositePackage.MESSAGE_QUEUE__CAPACITY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case CompositePackage.MESSAGE_QUEUE__EVENT_REFERENCE:
