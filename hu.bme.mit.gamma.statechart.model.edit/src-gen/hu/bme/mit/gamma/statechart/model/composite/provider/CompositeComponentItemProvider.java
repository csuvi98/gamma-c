...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.gamma.statechart.model.composite.CompositeComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeComponentItemProvider extends ComponentItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositePackage.Literals.COMPOSITE_COMPONENT__PORT_BINDINGS);
			childrenFeatures.add(CompositePackage.Literals.COMPOSITE_COMPONENT__CHANNELS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeComponent.class)) {
			case CompositePackage.COMPOSITE_COMPONENT__PORT_BINDINGS:
			case CompositePackage.COMPOSITE_COMPONENT__CHANNELS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CompositePackage.Literals.COMPOSITE_COMPONENT__PORT_BINDINGS,
				 CompositeFactory.eINSTANCE.createPortBinding()));

		newChildDescriptors.add
			(createChildParameter
				(CompositePackage.Literals.COMPOSITE_COMPONENT__CHANNELS,
				 CompositeFactory.eINSTANCE.createBroadcastChannel()));

		newChildDescriptors.add
			(createChildParameter
				(CompositePackage.Literals.COMPOSITE_COMPONENT__CHANNELS,
				 CompositeFactory.eINSTANCE.createSimpleChannel()));
	}
